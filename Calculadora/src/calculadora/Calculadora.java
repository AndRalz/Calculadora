...
public class Calculadora extends JFrame {
    ...
    private JFormattedTextField resp1;
...
public void operacion(){
    ...
    setSize(250,400);
    setLayout(null);
    Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("a22.png"));
    setIconImage(icon);
    ...
    n8 = new JButton("8"); text2 = new JLabel("");
    n9 = new JButton("9"); resp1 = new JFormattedTextField("");
    np = new JButton(".");
    ...
    add(resp);
    text.setBounds(55,0,210,55);
    add(text);
    text2.setBounds(10,40,210,55);
    add(text2);
    
    //// Escritura solo en numero///
    
    resp.addKeyListener(new KeyAdapter(){
        @Override
        public void keyPressed(KeyEvent ke) {
            String value = resp.getText();
            int l = value.length();
